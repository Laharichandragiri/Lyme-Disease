...
% Split the dataset into training and testing sets (20-20 split)
[imdsTrain, imdsTest] = splitEachLabel(imds, 0.2, 'randomized');
...
% Y_train = double(onehotencode(imdsTrain.Labels));
% 
...
% Display results
disp(['Attention transfer: ', num2str(accuracy * 100), '%']);
...
% Display results
disp(['Attention transfer+LSR: ', num2str(accuracy * 100), '%']);
